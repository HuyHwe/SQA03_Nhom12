...
export class Constants {
  ...
  public static loginQuote =
    'Cùng xây dựng một hồ sơ nổi bật và nhận được các cơ hội sự nghiệp lý tưởng';
     public static mathScoreLbl = 'Độ phù hợp CV';  
     public static reasonsLbl = 'Mô tả';
  ...
  public static transactionNameLbl = 'transactionNameLbl';
  public static transPointLbl = 'transPointLbl';
  public static transMoneyLbl = 'transMoneyLbl';
  public static transactionDateLbl = 'transactionDateLbl';
  // for admin
  ...
  // ============================================
  public static sequenceIndexLbl = 'sequenceIndexLbl';
...
//  public static districtNameDefault = 'Quận Ba Đình';
  public static wardNameDefault = 'Phường Hoàn Kiếm';
