...
import com.resourceservice.utilsmodule.constant.PaymentConfig;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentResDTO createPayment(PaymentReqDTO paymentReqDTO) throws UnsupportedEncodingException {
        ...
        BigDecimal amount = paymentReqDTO.getAmount().multiply(BigDecimal.valueOf(100));
        String bankCode = paymentReqDTO.getBankCode();
...
//        String vnp_TxnRef = formatter1.format(new Date().getTime());

        vnp_Params.put("vnp_TxnRef", vnp_TxnRef);
        vnp_Params.put("vnp_OrderInfo", "Thanh toan don hang:" + vnp_TxnRef);
        vnp_Params.put("vnp_OrderType", orderType);

        String locate = paymentReqDTO.getLanguage();
